import List from "./NewSnijinniyeObj";

import "../NewPros/NewPros.scss";
import { Link } from "react-router-dom";

const NewSnijenniye = () => {
  return (
    <div className="new-pros">
      <div className="new_pros">
        {List.map((item) => {
          return (
            <Link to="/news/infoItem" className="new_pros-list">
